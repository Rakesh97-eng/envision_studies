...
import {  integrationTwoTierOneSubscription, IntegrationTwoTierOneTitle, integrationTwoTierThreeSubscription, IntegrationTwoTierThreeTitle, integrationTwoTierTwoSubscription, IntegrationTwoTierTwoTitle } from "../../../utils/constants/subscriptionConstants";
...
export default function IntegrationTwoChoosePack({BankValue,ChangeTab, ChangeStatus}) {
      ...
      <Grid container>
        <Grid item xs={6}>
          {subscriptionPack === "Tier1" && (
            <SubscriptioncCard
              ChildCardText={IntegrationTwoTierOneTitle}
              ChildContentText={integrationTwoTierOneSubscription}
            />
          )}
          {subscriptionPack === "Tier2" && (
            <SubscriptioncCard
              ChildCardText={IntegrationTwoTierTwoTitle}
              ChildContentText={integrationTwoTierTwoSubscription}
            />
          )}
          {subscriptionPack === "Tier3" && (
            <SubscriptioncCard
              ChildCardText={IntegrationTwoTierThreeTitle}
              ChildContentText={integrationTwoTierThreeSubscription}
            />
          )}
        </Grid>
        <Grid item xs={6}>
