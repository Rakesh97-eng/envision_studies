...
import {  integrationOneTierOneSubscription, IntegrationOneTierOneTitle, IntegrationOneTierThreeTitle, integrationOneTierTwoSubscription, IntegrationOneTierTwoTitle, intergationOneTierThreeSubscription } from "../../../utils/constants/subscriptionConstants";
...
export default function IntegrationOneChoosePack({BankValue,ChangeTab, ChangeStatus}) {
      ...
      <Grid container>
        <Grid item xs={6}>
          {subscriptionPack === "Tier1" && (
            <SubscriptioncCard
              ChildCardText={IntegrationOneTierOneTitle}
              ChildContentText={integrationOneTierOneSubscription}
            />
          )}
          {subscriptionPack === "Tier2" && (
            <SubscriptioncCard
              ChildCardText={IntegrationOneTierTwoTitle}
              ChildContentText={integrationOneTierTwoSubscription}
            />
          )}
          {subscriptionPack === "Tier3" && (
            <SubscriptioncCard
              ChildCardText={IntegrationOneTierThreeTitle}
              ChildContentText={intergationOneTierThreeSubscription}
            />
          )}
        </Grid>
        <Grid item xs={6}>
