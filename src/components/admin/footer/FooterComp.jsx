...
const FooterComp = () => {
  ...
  return (
    <div className='footer' style={{ backgroundColor: "#3E4B5C", padding: "2rem 2rem", width: "100%",height:"100px" }}>
      <div className='row' style={{ width: "100%" }}>
        ...
        <div className='col-lg-2'>
          ...
          <Typography onClick={()=>handleNavigation('/dashboard/integration1')} variant="title2" component={"div"} sx={{ color: "#16BEEB", cursor: "pointer", fontSize: "16px",marginBottom:"5px" }}>
            Dashboard
          </Typography>
          <Typography onClick={()=>handleNavigation('/update-profile')} variant="title2" component={"div"} sx={{ color: "#16BEEB", cursor: "pointer", fontSize: "16px",marginBottom:"5px" }}>
            Update Profile
          </Typography>
          <Typography onClick={()=>handleNavigation('/invite-users')}  variant="title2" component={"div"} sx={{ color: "#16BEEB", cursor: "pointer", fontSize: "16px",marginBottom:"5px" }}>
            Invite User
          </Typography>
        </div>
        <div className='col-lg-2'>
